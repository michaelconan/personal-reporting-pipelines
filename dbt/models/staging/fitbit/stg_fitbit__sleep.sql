...
with sleep as (
    ...
    select
        ...
        cast(start_time as timestamp) as started_at,  -- Sleep duration in minutes (calculated)
        cast(end_time as timestamp) as ended_at,  -- Sleep duration in hours (calculated)
        type as sleep_type,  -- Timestamp when sleep started
        log_type,  -- Timestamp when sleep ended
        duration / 60000.0 as sleep_minutes,  -- Type of sleep (classic, stages)
        duration / 3600000 as duration_hr,  -- Log type classification
